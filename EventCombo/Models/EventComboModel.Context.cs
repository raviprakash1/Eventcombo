...
namespace EventCombo.Models
{
    ...
    public partial class EventComboEntities : DbContext
    {
        ...
        public virtual ObjectResult<GetEventsListByStatus1_Result> GetEventsListByStatus(string eventTitle, string eventStatus, string userID)
        {
            var eventTitleParameter = eventTitle != null ?
                new ObjectParameter("EventTitle", eventTitle) :
                new ObjectParameter("EventTitle", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetEventsListByStatus1_Result>("GetEventsListByStatus", eventTitleParameter, eventStatusParameter, userIDParameter);
        }
