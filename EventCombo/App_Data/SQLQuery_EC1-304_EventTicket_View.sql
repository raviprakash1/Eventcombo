/****** Object:  View [dbo].[EventTicket_View]    Script Date: 08-Aug-16 12:53:13 PM ******/
SET ANSI_NULLS ON
GO
...
SELECT 
	...
	ISNULL(Ticket.EC_Fee,0)-ISNULL(Ticket.T_EcAmount,0) AS ECFeePerTicket,
	Ticket.T_EcAmount AS MerchantFeePerTicket,
